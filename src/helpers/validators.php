...
Validator::register('username_not_banned', function($attribute, $value, $parameters)
{
	$bans = fluxbb\Models\Ban::all();
...
Validator::register('username_not_guest', function($attribute, $value, $parameters)
{
	return strcasecmp($value, 'Guest') && strcasecmp($value, __('fluxbb::common.guest'));
});

Validator::register('username_not_reserved', function($attribute, $value, $parameters)
{
	return !str_contains($value, array('[', ']', '\'', '"'));
});

Validator::register('no_ip', function($attribute, $value, $parameters)
{
...
Validator::register('no_bbcode', function($attribute, $value, $parameters)
{
...
Validator::register('not_censored', function($attribute, $value, $parameters)
{
